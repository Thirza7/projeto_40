    ...
    play(){
                ...
                player.getPlayerAtEnd();
                 ...
                 for(var plr in allPlayers){
                     ...
                     index = index+1;
                     //na variável x e y, há a posição da cesta do jogador.
                     ...
                     if(index === player.index){
                        ...
                        //no lugar de player1 e player2, coloque name, pois está é a propriedade de allPlayers que tem o nome do jogador. 
                        //use as variáveis x e y para definir a posição do texto do player 1
                         text("player 1" +allPlayers[plr].name, x, 500);
                     }
